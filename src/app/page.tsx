...
export default function Home() {
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-start sm:items-center justify-items-center bg-white dark:bg-gray-950 min-h-screen p-8  gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] transition-colors duration-200">
      <header className="row-start-1 flex gap-[24px] flex-wrap items-end justify-between w-full max-w-[640px] mx-auto">
        <h1 className="text-2xl font-bold text-left dark:text-[#666]">Git Commit<br/>Message Generator</h1>
        <Credentials />
      </header>
